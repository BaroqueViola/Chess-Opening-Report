...
Define a function lichess() where the user inputs the 8 character game code e.g. qzsgQdLe, return a dictionary containing the following: ```python {'opening': 'name', 'moves': [list_of_moves]}```
